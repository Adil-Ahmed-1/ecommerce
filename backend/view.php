          ...
          <tbody class="divide-y divide-gray-50 dark:divide-white/[0.03]">
            ...
            <tr class="hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition">
              <td class="px-5 py-3.5">
                <a href="order-detail.php?id=<?= $row['id'] ?>" class="font-bold text-gray-900 dark:text-white hover:text-brand-500 transition text-xs font-mono">#<?= htmlspecialchars($row['order_id']) ?></a>
              </td>
              <td class="px-5 py-3.5">
              ...
              <td class="px-5 py-3.5 text-center">
                <a href="order-detail.php?id=<?= $row['id'] ?>" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-brand-50 dark:bg-brand-950 text-brand-600 dark:text-brand-400 rounded-lg text-[11px] font-semibold hover:bg-brand-100 dark:hover:bg-brand-900 transition">
